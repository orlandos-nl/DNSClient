private let opCodeBits: UInt16 = 0b01111000_00000000
private let resultCodeBits: UInt16 = 0b00000000_00001111
...
public struct MessageOptions: OptionSet, ExpressibleByIntegerLiteral {
    ...
    public var isAnswer: Bool {
        self.contains(.answer)
    }

    public var isAuthorativeAnswer: Bool {
        self.contains(.authorativeAnswer)
    }
    ...
    public var isStandardQuery: Bool {
        rawValue & opCodeBits == MessageOptions.standardQuery.rawValue
    }

    public var isInverseQuery: Bool {
        rawValue & opCodeBits == MessageOptions.inverseQuery.rawValue
    }

    public var isServerStatusQuery: Bool {
        rawValue & opCodeBits == MessageOptions.serverStatusQuery.rawValue
    }

    public var isSuccessful: Bool {
        self.contains(.resultCodeSuccess)
    }

    public var isFormatError: Bool {
        self.contains(.resultCodeFormatError)
    }

    public var isServerFailure: Bool {
        self.contains(.resultCodeServerfailure)
    }

    public var isNameError: Bool {
        self.contains(.resultCodeNameError)
    }

    public var isNotImplemented: Bool {
        self.contains(.resultCodeNotImplemented)
    }

    public var isNotRefused: Bool {
        self.contains(.resultCodeNotRefused)
    }
